...
public class TesteControlador
{
	...
	public static void testeControladorRegistradora()
	{
		...
		System.out.println("Teste de Integração do Controlador Registradora - Sistema de Estoque DELL");

		controladorRegistradora.criarSistemaEstoqueAdapter("DELL");
		controladorRegistradora.diminuirQuantidadeItem();
		
		System.out.println("Teste de Integração do Controlador Registradora - Sistema de Estoque IBM");
		
		controladorRegistradora.criarSistemaEstoqueAdapter("IBM");
		controladorRegistradora.diminuirQuantidadeItem();
		
		System.out.println("Teste de Integração do Controlador Registradora - Sistema Estoque SAP");

		controladorRegistradora.criarSistemaEstoqueAdapter("SAP");
		controladorRegistradora.diminuirQuantidadeItem();
		
		System.out.println("Teste de Integração do Controlador Registradora - Sistema Contabil DELL");
		
		controladorRegistradora.criarSistemaContabilAdapter("DELL");
		controladorRegistradora.registrarVendaSistemaContabil();
		
		
		System.out.println("Teste de Integração do Controlador Registradora - Sistema Contabil IBM");

		controladorRegistradora.criarSistemaContabilAdapter("IBM");
		controladorRegistradora.registrarVendaSistemaContabil();
		
		System.out.println("Teste de Integração do Controlador Registradora - Sistema Contabil SAP");
